...
class Go2FRForwardStepController:
    def __init__(self, interface=None, sim=True):
        ...
        self.swing_sequence = [ "RL", "RR", "FR", "FL"] #sequence of swinging legs
        ...
        self.shift_x_des_front = -0.06 #shifting of the com after the walk
        self.shift_x_des_rear = -0.09

        self.shift_y_des = 0.02

        self.initial_stabilize_duration = 2.5
        self.com_shift_duration = 1.
        self.fr_lift_duration = 0.4
        self.fr_hold_duration = 0. #hold the leg in the air, maybe not necessary
    ...
    def swing_foot_torque(self, leg, target_pos): #computes torque to swinging leg (try to lift two at the same time)
        ...
        v_leg = J @ dq_leg
        kp =3 * np.diag([100.0, 100.0, 100.0])
