...
class Go2Controller:
    def __init__(self, interface=None, sim=False):
        ...
        # ------------------------------------------------------------
        self.height_sequence = [0.30, 0.2, 0.35]
        ...
        self.tau_debug_period = 0.10  # print every 100 ms
        ...
        self.vmc_debug_period = 2.0  # seconds
            ...
            if t < self.time_up:
                ...
                if t_vmc < self.vmc_cycle_duration:
                    ...
                    for i in range(4):
                        ...
                        # This should NOT be ramped from zero, otherwise the robot falls.
